package com.io.tedtalk.constants;

public class TedTalkConstants {
	
	public static final String TEDTALK_NOT_FOUND = "TEDTALK_NOT_FOUND";
	...
	public static final String TEDTALK_SAVED_SUCCESSFULLY = "TEDTALK_SAVED_SUCCESSFULLY";
